...
from innexiaBot import pgram as app
from innexiaBot.utils.inlinefuncs import *

__mod_name__ = ""
__help__ = """This Plugin Can Be Used For Inline Purpose!\nTo use , Simple Type @BGxRobot <command>"""
