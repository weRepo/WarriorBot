...
DONATE_STRING = """Contact @TheCloneX For Donations!"""
    ...
    if query.data == "innexia_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aᴅᴍɪɴ", callback_data="TheBG_devs"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Lᴏɢ'ꜱ", url="t.me/TheBG_Logs"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ʜɪᴍᴀɴsʜᴜ", url="t.me/cloneXcopy"),
                    InlineKeyboardButton(text="ᴀᴋᴀɴᴋsʜᴀ", url="t.me/itsme_akii"),
                 ],
                 [
                    InlineKeyboardButton(text="ᴍʀ ɪɴғɪɴɪᴛʏ", url="https://t.me/MrInfinity_robot"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_basichelp"),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 2011519525 and DONATION_LINK:
            update.effective_message.reply_text(
